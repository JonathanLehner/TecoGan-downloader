...
link_path = "https://pornhub.com/view_video.php?viewkey="
video_data_dict = { 
# Videos and frames are hard-coded. 
# We select frames to make sure that there is no scene switching in the data
# We assume that the Flags.duration is 120
    #"ph5d601770e24d5" : [74] #1
    #"ph592f13a6edbe8": [Flags.start_frame],
    Flags.video_key: [Flags.start_frame]
    #"ph584f495de3f67": [0],
    #"ph5881326e40d57": [0],
    #"ph5853720a3d4c6": [0],
    #"ph59c30788a4181": [0]
...
for keys in video_data_dict:
    ...
    # download video from vimeo/pornhub
    try:
        info_dict = ydl.extract_info(tar_vid_input, download=saveframes)
        info_dict["width"] = info_dict["height"] # for pornhub
    ...
    for start_fr in video_data_dict[keys]:
        ...
        gen_frames(tar_vid_output, tar_dir, info_dict["width"], info_dict["height"], start_fr, Flags.duration, True) #saveframes)
        cur_id = cur_id+1
